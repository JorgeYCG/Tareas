<!--inicia funciones del cronometro-->
...
<!--termina funciones del cronometro-->

<!--inicia funciones del caracter-->
function validar(){
...
<!--termina la funciones del caracter-->

<!--inicia funciones de horas trabajadas-->

        function contenido(id){
            return document.getElementById(id)
}
        function calcularsal(){
        var pn= parseInt(contenido('sal').value)
        var porcent=100;
        const incre=28;
        const decre=20;
       if (pn>=28) {
